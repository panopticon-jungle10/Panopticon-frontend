...
export default function AddServiceCard({ onClick }: AddServiceCardProps) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={isDisabled}
      className={`h-full min-h-[180px] rounded-2xl border-2 border-dashed border-gray-300 bg-white p-5 flex flex-col items-center justify-center text-gray-500 transition hover:-translate-y-1 hover:shadow-md ${
