...
export function InstallSection({ heading, description, meta, code, language }: InstallSectionProps) {
  return (
    <div>
      ...
      {description && <p className="text-sm text-gray-600 mb-3 whitespace-pre-line">{description}</p>}
