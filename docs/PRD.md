...
#### 3.1.1 대시보드
- [ ] 등록된 서비스 목록 표시
- [ ] 서비스별 요약 메트릭 (요청 수, 에러율, 평균 레이턴시)
- [ ] 드래그 앤 드롭 위젯 커스터마이징
- [ ] 시간 범위 선택 (15분 ~ 7일)

#### 3.1.2 서비스 상세
- [ ] 실시간 메트릭 차트 (요청 수, 에러율, 레이턴시)
- [ ] 엔드포인트별 성능 테이블
- [ ] 에러 로그 실시간 스트리밍
- [ ] 차트 클릭 시 해당 시간대 트레이스 조회

#### 3.1.3 트레이스 분석
- [ ] Waterfall View: 시간 순서대로 스팬 시각화
- [ ] Flame Graph: 호출 스택 시각화
- [ ] Map View: 서비스 간 관계 시각화
- [ ] Span List: 스팬 상세 정보 테이블

#### 3.1.4 알림 시스템
- [ ] SLO(Service Level Objective) 정의
- [ ] 임계치 기반 알림 규칙 설정
- [ ] 다중 알림 채널 (Slack, Discord, Teams, Email)
- [ ] 알림 이력 조회
